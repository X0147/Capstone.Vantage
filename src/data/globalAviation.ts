...
export const GLOBAL_AIRPORTS: Airport[] = [
  ...
  { code: 'DFW', name: 'Dallas/Fort Worth International', city: 'Dallas', country: 'United States', timezone: 'CST' },
  { code: 'SFO', name: 'San Francisco International', city: 'San Francisco', country: 'United States', timezone: 'PST' },
  { code: 'SEA', name: 'Seattle-Tacoma International', city: 'Seattle', country: 'United States', timezone: 'PST' },
  ...
  { code: 'DME', name: 'Domodedovo International', city: 'Moscow', country: 'Russia', timezone: 'MSK' },
  { code: 'BCN', name: 'Barcelona–El Prat Airport', city: 'Barcelona', country: 'Spain', timezone: 'CET' },
  { code: 'CPH', name: 'Copenhagen Airport', city: 'Copenhagen', country: 'Denmark', timezone: 'CET' },
  { code: 'ATH', name: 'Athens International Airport', city: 'Athens', country: 'Greece', timezone: 'EET' },
  ...
  { code: 'PVG', name: 'Shanghai Pudong International', city: 'Shanghai', country: 'China', timezone: 'CST' },
  ...
  { code: 'KUL', name: 'Kuala Lumpur International', city: 'Kuala Lumpur', country: 'Malaysia', timezone: 'MYT' },
  { code: 'CGK', name: 'Soekarno–Hatta International', city: 'Jakarta', country: 'Indonesia', timezone: 'WIB' },
  { code: 'TPE', name: 'Taiwan Taoyuan International', city: 'Taipei', country: 'Taiwan', timezone: 'NST' },
  { code: 'SGN', name: 'Tan Son Nhat International', city: 'Ho Chi Minh City', country: 'Vietnam', timezone: 'ICT' },
  ...
  { code: 'ADD', name: 'Bole International Airport', city: 'Addis Ababa', country: 'Ethiopia', timezone: 'EAT' },
  { code: 'NBO', name: 'Jomo Kenyatta International', city: 'Nairobi', country: 'Kenya', timezone: 'EAT' },
  { code: 'RUH', name: 'King Khalid International', city: 'Riyadh', country: 'Saudi Arabia', timezone: 'AST' },
  ...
  { code: 'BNE', name: 'Brisbane Airport', city: 'Brisbane', country: 'Australia', timezone: 'AEST' },
  { code: 'AKL', name: 'Auckland Airport', city: 'Auckland', country: 'New Zealand', timezone: 'NZST' },

  // ==================== SOUTH & CENTRAL AMERICA ====================
  { code: 'GRU', name: 'São Paulo/Guarulhos International', city: 'São Paulo', country: 'Brazil', timezone: 'BRT' },
  { code: 'GIG', name: 'Rio de Janeiro/Galeão International', city: 'Rio de Janeiro', country: 'Brazil', timezone: 'BRT' },
  { code: 'EZE', name: 'Ministro Pistarini International', city: 'Buenos Aires', country: 'Argentina', timezone: 'ART' },
  { code: 'SCL', name: 'Arturo Merino Benítez International', city: 'Santiago', country: 'Chile', timezone: 'CLT' },
  { code: 'LIM', name: 'Jorge Chávez International', city: 'Lima', country: 'Peru', timezone: 'PET' },
  { code: 'BOG', name: 'El Dorado International Airport', city: 'Bogotá', country: 'Colombia', timezone: 'COT' },
];
...
export const GLOBAL_AIRLINES: Airline[] = [
  ...
  { code: 'LX', name: 'Swiss International Air Lines', alliance: 'Star Alliance' },
  ...
  { code: 'SG', name: 'SpiceJet', alliance: 'Independent' },
  { code: '6E', name: 'IndiGo', alliance: 'Independent' },
  { code: 'RY', name: 'Ryanair', alliance: 'Independent' },
  { code: 'U2', name: 'EasyJet', alliance: 'Independent' },
];
